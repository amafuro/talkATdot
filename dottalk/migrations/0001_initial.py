# Generated by Django 4.1 on 2022-09-13 04:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('posted_at', models.DateTimeField(auto_now_add=True)),
                ('Idea', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='idea_comments', to='dottalk.idea')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
